...
import { GenderTennisComponent } from 'app/entities/gender-tennis/gender-tennis.component';
...
describe('Component Tests', () => {
  describe('GenderTennis Management Component', () => {
    let comp: GenderTennisComponent;
    let fixture: ComponentFixture<GenderTennisComponent>;
    let service: GenderTennisService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [TennisJazzTestModule],
        declarations: [GenderTennisComponent],
        providers: [
          {
        ...
        .overrideTemplate(GenderTennisComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(GenderTennisComponent);

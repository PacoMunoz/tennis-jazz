...
import { TournamentTennisComponent } from 'app/entities/tournament-tennis/tournament-tennis.component';
...
describe('Component Tests', () => {
  describe('TournamentTennis Management Component', () => {
    let comp: TournamentTennisComponent;
    let fixture: ComponentFixture<TournamentTennisComponent>;
    let service: TournamentTennisService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [TennisJazzTestModule],
        declarations: [TournamentTennisComponent],
        providers: [
          {
        ...
        .overrideTemplate(TournamentTennisComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TournamentTennisComponent);

...
import { PlayerTennisComponent } from 'app/entities/player-tennis/player-tennis.component';
...
describe('Component Tests', () => {
  describe('PlayerTennis Management Component', () => {
    let comp: PlayerTennisComponent;
    let fixture: ComponentFixture<PlayerTennisComponent>;
    let service: PlayerTennisService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [TennisJazzTestModule],
        declarations: [PlayerTennisComponent],
        providers: [
          {
        ...
        .overrideTemplate(PlayerTennisComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PlayerTennisComponent);

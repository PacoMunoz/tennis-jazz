...
import es.pmg.tennisjazz.config.Constants;
import es.pmg.tennisjazz.config.audit.AuditEventConverter;
import es.pmg.tennisjazz.domain.PersistentAuditEvent;
...
import static es.pmg.tennisjazz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

...
public class PlayerResource {
     ...
     */
    @GetMapping("/players")
    public ResponseEntity<List<Player>> getAllPlayers(PlayerCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

...
public class TournamentGroupResource {
    ...
    public ResponseEntity<List<TournamentGroup>> getAllTournamentGroups(TournamentGroupCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

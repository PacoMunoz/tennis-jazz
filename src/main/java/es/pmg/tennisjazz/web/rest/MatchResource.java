...
public class MatchResource {
     ...
     */
    @GetMapping("/matches")
    public ResponseEntity<List<Match>> getAllMatches(MatchCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

...
import es.pmg.tennisjazz.security.*;
import es.pmg.tennisjazz.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.GET, "/api/rounds/**").permitAll()
            .antMatchers(HttpMethod.GET, "/api/tournament-groups/**").permitAll()
